      ...
      <ul class="dropdown-menu" :class="{ show: isOpen }">
        ...
        <li class="button-container">
          <social-sharing
            :url="shareUrl"
            inline-template
            title="AIRS plugin - Plugin for POS"
          ...
          >
            <div class="centered-buttons">
              <ShareNetwork
                title=""
                url="https://www.linkedin.com/in/dhouch/"
                network="facebook"
...
export default {
  ...
  data() {
    return {
      documentationLink:
        "https://www.linkedin.com/in/dhouch/",
      shareUrl: "https://www.linkedin.com/in/dhouch/",
      buyUrl: "",
      freeUrl: "https://www.linkedin.com/in/dhouch/",
      isOpen: false,
      sidebarColors: [
